  ...
  return (
    <SafeAreaView style={tw`flex-1`}>
      ...
      >
        ...
        >
          {/* width: "100%", flex: 0.25, justifyContent: "flex-start",
          borderBottomLeftRadius: 20, borderBottomRightRadius: 20, alignItems:
          "center", marginBottom: "17%", */}
          <View
            style={[
          ...
          >
            <View style={tw`flex-row justify-end`}>
              ...
              <Image
                style={[tw`rounded-full ml-4 mt-4`, { width: 50, height: 50 }]}
          ...
          <View style={tw`ml-4 mr-4 justify-center flex-col mt-4`}>
            ...
            <Text style={tw`text-gray-600 text-sm`}>
              Check out this week’s selection of popular places that might catch
              you eye.
            </Text>
          </View>
          <View>
